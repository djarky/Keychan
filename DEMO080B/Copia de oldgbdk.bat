...
C:\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -DUSE_SFR_FOR_REG -Wl-yt0x03 -Wl-yo16 -Wl-ya4 -Wl-yp0x143=0x00 -o game_mbc1.gb main.o BaterySave.o  player_control.o npc_control.o bo4.o sprites.o bitmaps1.o musical_mice.o compo_invaders.o bank12.o bank13.o bank14.o
C:\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -DUSE_SFR_FOR_REG -Wl-yt0x1b -Wl-yo16 -Wl-ya4 -Wl-yp0x143=0x00 -o game_mbc5.gb main.o BaterySave.o  player_control.o npc_control.o bo4.o sprites.o bitmaps1.o musical_mice.o compo_invaders.o bank12.o bank13.o bank14.o
