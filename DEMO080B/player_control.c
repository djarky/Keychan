...
void player_calcule_xy(){

if(player_pos_x_abs%16==0){
player_pos_x=(player_pos_x_abs/16);
}
if(player_pos_y_abs%16==0){
player_pos_y=(player_pos_y_abs/16);
}
 ...
 case J_UP:
   if(!(player_col & COL_D) || player_pos_y_abs%16 !=0 ){ 
      ...
      if(  (player_col & COL_DR) && ( (joy & J_RIGHT) && !(player_col & COL_R) ) ){
            ...
            if(player_pos_x_abs%16==0){player_scrollex(0,-1);}
 ...
 case J_LEFT:
   if(!(player_col & COL_R) ||  player_pos_x_abs%16 !=0  ){ 
      ...
      if(  (player_col & COL_UR) && ( (joy & J_UP) && !(player_col & COL_U) ) ){
            ...
            if(player_pos_y_abs%16==0){player_scrollex(-1,0);}
