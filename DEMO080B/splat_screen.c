...
nero1[2]=NR12_REG /0x20;
nero2[2]=NR22_REG /0x20;
nero3[2]=NR32_REG /0x20;


nero4[2]=NR42_REG /0x20;
nero4[3]=NR43_REG /0x20;




if(nero4[3]){
nero1[3]=NR12_REG /0x20;
nero2[3]=NR22_REG /0x20;
nero3[3]=NR32_REG /0x20;
}
else{
nero1[3]=0;
nero2[3]=0;
