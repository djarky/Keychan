#ifndef _ARKY_DOOR_TELEPORT_C
#define _ARKY_DOOR_TELEPORT_C
...
if(Doors[door_idx].in_door.x_pos == Doors[door_idx].out_door.x_pos && Doors[door_idx].in_door.y_pos == Doors[door_idx].out_door.y_pos){complete_game=0xFF;player_hp=0;return 1;}
