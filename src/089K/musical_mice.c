...
void play_mice_melody_normal(void) {
...
void play_mice_melody_inverted(void) {
...
void play_mice_melody_side_L(void) {
...
void play_mice_melody_side_R(void) {
...
void play_dubstep_inverted(void) {
k = ((sys_time >> 3) % 32);
	switch(k) {
	case 32:
	play_sound_C1(0x12, 0x43, 0x86, 0x87, 0xC3);
...
void play_glitch_melody_normal(void) {
  k = ((sys_time >> 3) % 32);
...
void play_glitch_melody_inverted(void) {
  k = ((sys_time >> 3) % 32);
